...
var Employees = React.createClass({
	...
	onDeleteBtnClicked: function() {
		...
		axios.delete('http://172.16.1.129:8080/employees/' + this.state.selectedEmployeeId)
	...
	getEmployees: function() {
	  return axios.get('http://172.16.1.129:8080/employees');
	},

	getDepartments: function() {
	  return axios.get('http://172.16.1.129:8080/departments');
	},
